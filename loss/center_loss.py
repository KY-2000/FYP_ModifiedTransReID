...
class CenterLoss(nn.Module):
    ...
    Args:
     ...
     ECCV2016年的这篇文章主要是提出了一个新的Loss：Center Loss，以辅助Softmax Loss进行人脸的训练。
     主要就是先利用Softmax loss来分开不同类别，然后利用Center Loss来压缩某一类。最终获得discriminative features。
     https://blog.csdn.net/Roaddd/article/details/114381848
    """
